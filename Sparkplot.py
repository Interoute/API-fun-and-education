# 2014-12-10: Modified version of sparkplot.py
# Author: Phillip Kent, phillip.kent@interoute.com
#
# Download at: https://github.com/Interoute/API-fun-and-education
#
# Based on the original program: http://sparkplot.org/browser/sparkplot.py
#
